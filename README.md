...
1. Install Wrangler, Rust, Node, and PNPM (or npm) locally.
2. Configure Cloudflare account/environment variables for D1, AE, R2, and Access.
...
For deeper context on functional requirements and architecture see `docs/the-plan.md`; pair it with the roadmap doc to track progress.
